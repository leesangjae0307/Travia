...
// 분리된 컴포넌트 import (상대 경로 수정)
import BookingBox from '../components/BookingBox.jsx'; // pages 폴더에서 나와서 components 폴더로
import ReviewList from '../components/ReviewList.jsx'; // pages 폴더에서 나와서 components 폴더로
import RelatedContentList from '../components/RelatedContentList.jsx'; // pages 폴더에서 나와서 components 폴더로
